...
## [Unreleased](https://github.com/cd-roman/uptime-monitor/compare/v1.0.6...HEAD)
...
## [v1.0.5](https://github.com/cd-roman/uptime-monitor/compare/v1.0.4...v1.0.5) - 2025-11-29

### Changed

- Update dependencies
- Update actions/checkout from v5 to v6 in workflows and documentation
